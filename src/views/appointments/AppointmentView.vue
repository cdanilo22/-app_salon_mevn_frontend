...
const disableDate = (date) => {
    ...
    return [0, 6].includes(date.getDay()) || date < today || date.getMonth() > today.getMonth() + 1 
...
<div class="space-y-8" v-if="!appointments.noServicesSelected">
    ...
    <div class="lg:flex gap-5 items-center">
        ...
        <div v-if="appointments.isDateSelected" class="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-5 mt-10 lg:mt-0">
            ...
            class="black text-blue-500 rounded-lg text-xl font-black p-3 disabled:opacity-10"
    ...
    <div v-if="appointments.isValidReservation" class="justify-end">
        <button
            class="w-full md:auto bg-blue-500 p-3 rounded-lg uppercase font-black text-white"
